...
const Exprience = () => {
 ...
 <div>
 <img src={pose2} className="max-w-lg rounded-lg" /> 
   
 </div>

    <div>
        
      <h1 className="text-xl text-secondary text-xl">16+ Years Experiences </h1>

      <h1 className="text-4xl font-bold">We Are Always ensure Best Medical Treatment For Your Health</h1>
